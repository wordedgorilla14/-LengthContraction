...
while running:
    ...
    if xb >= screen_width: #screen_height
        ...
        #vxb = -vxb # 벽에 도달하면 반발력 적용

    # Red 화면 경계처리
    if xr >= int(xT+300): #screen_height
        xr = int(xT+300)
        vxr = -vxr
    ...
    pygame.draw.line(screen, green, (int(xT+300), int(yr*(3/4)-100)), (int(xT+300), int(yr*(3/4)+100)))
